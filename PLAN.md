...
|---------------------|----------------------------------------------|-------------------------------------------------------------------------------------------------------|----------------------------------------------|
| **Speech-to-Text**  | **Whisper** (phiên bản `medium` hoặc `large-v3`) | - Độ chính xác cao nhất trong các mô hình open-source <br> - Hỗ trợ đa ngôn ngữ, có pretrained cho tiếng Việt <br> - Cải thiện xử lý tiếng ồn và accent <br> - Yêu cầu GPU mạnh cho phiên bản lớn | https://github.com/openai/whisper             |
