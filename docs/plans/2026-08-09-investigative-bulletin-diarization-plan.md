...
| S2 | `docs/plans/2026-08-09-investigative-bulletin-diarization-plan.md`; `src/core/config.py`; `src/services/model_runtime/__init__.py`; `src/services/model_runtime/gpu_lease.py`; `src/services/investigation/__init__.py`; `src/services/investigation/canonicalization.py`; `src/services/investigation/claim_semantics.py`; `src/services/investigation/contracts.py`; `src/services/investigation/contradictions.py`; `src/services/investigation/narrative_attestation.py`; `src/services/investigation/reasoning_contracts.py`; `src/services/investigation/release_adapter.py`; `src/services/investigation/run_contracts.py`; `src/services/investigation/verification.py`; `src/services/investigation/verification_contracts.py`; `src/services/summarization/bulletin_writer.py`; `src/services/summarization/contracts.py`; `src/services/summarization/context_service.py`; `src/services/summarization/deterministic_analysis.py`; `src/services/summarization/investigation_preview.py`; `src/services/summarization/investigation_scenarios.py`; `src/services/summarization/public_projection.py`; `src/services/summarization/models/context_analysis.py`; `src/services/summarization/models/investigation_knowledge.py`; `src/services/summarization/models/llm_manager.py`; `src/services/summarization/models/openai_compatible_client.py`; `src/services/summarization/summary_service_v2.py` | `scripts/audit_summary_diarization_readiness.py`; `scripts/evaluate_context_analysis.py`; `tests/test_adaptive_summary_contracts.py`; `tests/test_context_analysis.py`; `tests/test_deterministic_transcript_analysis.py`; `tests/test_investigative_bulletin_quality.py`; `tests/test_investigation_canonicalization.py`; `tests/test_investigation_knowledge.py`; `tests/test_investigation_release_adapter.py`; `tests/test_investigation_summary_runtime.py`; `tests/test_investigation_verification.py`; `tests/test_local_llm_optimization.py`; `tests/test_openai_compatible_llm.py`; `tests/test_public_summary_projection.py`; `tests/test_summary_diarization_audit_harness.py`; `docs/reviews/artifacts/s1-summary-schema.json`; `docs/reviews/artifacts/s2-narrative-release.json` |
| S3 | `docs/plans/2026-08-09-investigative-bulletin-diarization-plan.md`; `src/services/summarization/contracts.py`; `src/services/summarization/summary_service_v2.py`; `src/services/audio_service.py`; `src/api/endpoints/audio_v2.py`; `src/api/endpoints/audio.py`; `src/api/endpoints/summary.py`; `src/worker/tasks/summarize_task.py`; `frontend/src/api/client.ts`; `frontend/src/App.tsx`; `frontend/src/components/SummarizeDialog.tsx`; `frontend/src/components/TaskList.tsx` | `scripts/audit_summary_diarization_readiness.py`; `tests/test_summary_request_contract.py`; `tests/test_summary_visualization_separation.py`; `tests/test_local_llm_optimization.py`; `tests/test_security.py`; `tests/test_summary_diarization_audit_harness.py`; `frontend/tests/summaryRequestContract.test.ts`; `docs/reviews/artifacts/s3-summary-request-contract.json` |
| S4 | `docs/plans/2026-08-09-investigative-bulletin-diarization-plan.md`; `src/api/endpoints/audio_v2.py`; `src/api/endpoints/audio.py`; `src/worker/tasks.py`; `src/worker/tasks/summarize_task.py`; `src/services/audio_service.py`; `src/services/task_service.py`; `src/services/transcription/transcribe_service_v2.py`; `src/services/summarization/summary_service_v2.py`; `src/services/summarization/context_service.py`; `src/services/summarization/models/llm_manager.py`; `frontend/src/App.tsx`; `frontend/src/components/FileCard.tsx` | `scripts/assert_summary_replay.py`; `scripts/audit_summary_diarization_readiness.py`; `scripts/probe_celery_worker_contract.py`; `scripts/replay_summary_task.ps1`; `tests/test_assert_summary_replay.py`; `tests/test_summary_fail_closed.py`; `tests/test_summary_request_contract.py`; `tests/test_summary_visualization_separation.py`; `tests/test_worker_runtime_contract.py`; `tests/test_security.py`; `frontend/tests/summaryRequestContract.test.ts`; `docs/runbooks/celery-summary-replay.md`; `docs/reviews/artifacts/s4-summary-state-transitions.json` |
...
- `src/core/config.py` and shared GPU lease files required by direct service callers
...
- readiness evidence validator plus schema-compatibility, deterministic-analysis,
  bulletin, knowledge, contract, runtime-client, canonicalization, verification,
  and release tests
