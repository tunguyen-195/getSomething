...
class Settings(BaseSettings):
    ...
    WHISPER_VAD_THRESHOLD: float = 0.4
    WHISPER_VAD_MIN_SPEECH_MS: int = 200
    WHISPER_VAD_MIN_SILENCE_MS: int = 1500
    WHISPER_VAD_SPEECH_PAD_MS: int = 800
    ...
    ASR_GUARD_ENABLED: bool = True
    ASR_GUARD_MIN_AVG_LOGPROB: float = -1.25
    ASR_GUARD_MAX_NO_SPEECH_PROB: float = 0.75
    ASR_GUARD_MAX_COMPRESSION_RATIO: float = 2.6
    ASR_SEGMENT_MAX_SECONDS: float = 18.0
    ASR_SEGMENT_MERGE_GAP_SECONDS: float = 0.7
